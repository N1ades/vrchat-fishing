...
## Видео
https://github.com/user-attachments/assets/c1548202-ce3a-4413-97a6-14a4d4f4dfbe
...
> 1. Откройте этот файл для редактирования на GitHub
> 2. Перетащите видео файл `Запись 2025-11-01 132616-00.00.00.000-00.01.01.141-cut-merged-1761993242526.mp4` в редактор
> 3. GitHub автоматически загрузит и создаст правильную ссылку
>
> *Видео показывает работу бота в реальном времени: автоматический заброс, визуализация звука и подсечка*
