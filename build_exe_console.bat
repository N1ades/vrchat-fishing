...
chcp 65001 > nul
echo ============================================
echo VRChat Fishing Bot - Сборка EXE (с консолью)
echo ============================================
echo.
...
echo.
echo Сборка EXE файла (с окном консоли для отладки)...
...
python -m PyInstaller --noconfirm ^
    --onefile ^
    --console ^
    --name "VRChat_Fishing_Bot_Console" ^
    --icon=NONE ^
...
echo ============================================
echo.
echo EXE файл создан: dist\VRChat_Fishing_Bot_Console.exe
echo.
echo ВАЖНО: Скопируйте fishing_bot_settings.json
echo в ту же папку, где будет находиться EXE файл!
echo.
echo Эта версия показывает консоль с логами для отладки.
echo.
pause
